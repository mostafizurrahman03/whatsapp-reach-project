<section class="bg-white py-16">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="space-y-4">
            ...
            <details class="group bg-gray-50 p-4 sm:p-5 rounded-xl border border-gray-200 hover:border-[#0F7B71]/40 transition">
                <summary class="cursor-pointer font-semibold text-gray-900 flex justify-between items-center gap-3">
                    <span class="inline-flex items-center text-lg sm:text-xl gap-2">
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-[#D6F8E8] text-[#0F7B71]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M4 5h16v14H4V5zm8 2a3 3 0 110 6 3 3 0 010-6zm-6 10h12a5 5 0 00-12 0z"/></svg>
                        </span>
            ...
            <details class="group bg-gray-50 p-4 sm:p-5 rounded-xl border border-gray-200 hover:border-[#0F7B71]/40 transition">
                <summary class="cursor-pointer font-semibold text-gray-900 flex justify-between items-center gap-3">
                    <span class="inline-flex items-center text-lg sm:text-xl gap-2">
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-[#D6F8E8] text-[#0F7B71]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l7 4v6c0 5-3.5 9.74-7 10-3.5-.26-7-5-7-10V6l7-4zm0 4.18L7 7.82V12c0 3.45 2.39 7.16 5 7.78 2.61-.62 5-4.33 5-7.78V7.82l-5-1.64z"/></svg>
                        </span>
                        Is it safe to use?
                    </span>
                    <span class="ml-2 text-[#0F7B71] text-3xl leading-none font-extrabold select-none group-open:hidden">+</span>
            ...
            <details class="group bg-gray-50 p-4 sm:p-5 rounded-xl border border-gray-200 hover:border-[#0F7B71]/40 transition">
                <summary class="cursor-pointer font-semibold text-gray-900 flex justify-between items-center gap-3">
                    <span class="inline-flex items-center text-lg sm:text-xl gap-2">
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-[#D6F8E8] text-[#0F7B71]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M3 7h18v2H3V7zm0 4h12v2H3v-2zm0 4h18v2H3v-2z"/></svg>
                        </span>
        ...
        <div class="mt-10 text-center">
            <div class="inline-flex items-center gap-3 rounded-2xl border border-[#0F7B71]/20 bg-[#D6F8E8] px-4 py-3">
                <span class="inline-flex h-7 w-7 items-center justify-center rounded-md bg-[#0F7B71] text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-4 w-4"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 14h-2v-2h2v2zm0-4h-2V7h2v5z"/></svg>
                </span>
                <div class="text-left">
                    <p class="text-sm font-semibold text-gray-900">Still have questions?</p>
                    <p class="text-xs text-gray-600">We’re here to help you get set up the right way.</p>
                </div>
                <a href="{{ route('contact') }}" class="ml-2 inline-flex items-center gap-2 rounded-full bg-[#0F7B71] px-3.5 py-2 text-white text-sm font-semibold shadow hover:bg-[#0c6a62] transition">Contact support</a>
            </div>
        </div>
    </div>
</section>
