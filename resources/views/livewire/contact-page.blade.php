    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Get in <span class="text-[#0F7B71]">Touch</span>
            </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            <div class="w-12 h-12 bg-[#0F7B71]/10 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-[#0F7B71]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-16 text-center">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <p class="text-gray-600 mb-6">For urgent matters, don't hesitate to reach out directly via WhatsApp or phone.</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="https://wa.me/1234567890" 
                       class="inline-flex items-center justify-center px-6 py-3 bg-[#0F7B71] hover:bg-[#0F7B71]/90 text-white font-medium rounded-lg transition-colors duration-200">
